 ...
 *
 *  Description: This is a class declaration for a DirNode. This class
 *  contains both public and priavte methods to construct nodes for the FSTree
 *  class. DirNodes are either files or subdirectories with the root being the
 *  user's inputted directory. 
 *
 */
