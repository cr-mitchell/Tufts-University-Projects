 ...
 *
 *  Description: This is a class declaration for a FSTree. This class
 *  contains both public and priavte methods to construct a n-ary tree with 
 *  inner nodes containing subdirectories, leaves contatining filenames, and
 *  the root containing the user's inputted directory. FSTree is built on
 *  the foundation of the DirNode class
 *
 */
